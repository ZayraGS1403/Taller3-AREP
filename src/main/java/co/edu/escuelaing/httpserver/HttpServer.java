...
public class HttpServer {
    ...
    public static void runServer(String[] args) throws IOException, URISyntaxException, IllegalAccessException {
    ...
    private static String invokeService(URI requri) throws IllegalAccessException {
    ...
    public static void start(String[] args) throws IOException, URISyntaxException, IllegalAccessException {
        runServer(args);
    }
